...
class Arena:
    ...
    def Init(self, dataPort):
        ...
        self.serialHandle = serial.Serial(self.arduinoPort, 115200, write_timeout = None, timeout = None)
        #self.serialHandle.port = dataPort
        #self.serialHandle.baut = 115200
        #self.serialHandle.write_timeout = None
        #self.serialHandle.timeout = None
    ...
    def SetTileTemp(self, t1, t2, t3):
        ...
        self.serialHandle.write(("settiletemp=" + str(t1) + "," + str(t2) + "," + str(t3) + "\n").encode("utf-8"))
    ...
    def LED(self, l1, l2):
        ...
        self.serialHandle.write(("leds=" + str(l1) + "," + str(l2) + "\n").encode("utf-8"))
